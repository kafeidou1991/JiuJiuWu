...
static NSString * const WXShareKey = @"wx4972cb3512eba2e6";
static NSString * const WXShareSecret = @"953b127a5f5417502426e5d617033232";

@interface CTShareTool ()<WXApiDelegate>
...
- (void)getAuthWithUserInfoFromWechatVC:(UIViewController *)vc Auth:(AuthWeChatCode)block
{
    ...
    if (![WXApi isWXAppInstalled] || ![WXApi isWXAppSupportApi]) {
        [JJWBase alertMessage:@"请安装最新版微信" cb:nil];
        return;
    }
    [self sendAuthRequest:vc];
}
-(void)sendAuthRequest:(UIViewController *)vc
{
    _isAuthing = YES;
    //构造SendAuthReq结构体

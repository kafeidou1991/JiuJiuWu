...
-(void)setupUI {
    ...
    self.pickThemeColor = RGB(247, 133, 51);
...
-(void)addLabelWithName:(NSArray *)nameArr {
    ...
    for (int i=0; i<nameArr.count; i++) {
        ...
        label.textColor = self.pickThemeColor;
...
//    if ([_scrollToDate compare:self.minLimitDate] != NSOrderedAscending) {
//        _scrollToDate = _maxLimitDate;
//    }
//    [self getNowDate:self.scrollToDate animated:NO];
//}
-(void)setPickThemeColor:(UIColor *)pickThemeColor{
    _pickThemeColor = pickThemeColor;
    self.doneBtn.backgroundColor = pickThemeColor;
}

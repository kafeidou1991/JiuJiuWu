...
#import "CenterLabel.h"

#define myfontSize  14.0  //设置字体大小
#define padingX    5.0  //设置图片与文字的距离
#define imgPadingX 4.0 //设置图片的内边距，即设置图片大小

@implementation CenterLabel

+(instancetype)CenterLabelView:(CGRect)frame andImageName:(NSString *)img
{
    CenterLabel *iclabel=[[CenterLabel alloc]initWithFrame:frame withimgName:img];

...
-(instancetype)init {
    if (self = [super initWithInitInfo:[self setupService] width:self.view.frame.size.width height:self.view.frame.size.height]) {
        self.topView.backgroundColor = JJWThemeColor;
...
-(void)viewDidLoad {
    [super viewDidLoad];
    WeakSelf
    [self setPageBlock:^(ZCUIChatController *object, ZCPageBlockType type) {
